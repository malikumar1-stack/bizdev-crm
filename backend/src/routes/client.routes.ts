...
router.patch('/:id/archive', requireRole(['ADMIN', 'MANAGER']), ClientController.archiveClient);
router.patch('/:id/restore', requireRole(['ADMIN', 'MANAGER']), ClientController.restoreClient);
...
router.patch('/contacts/:contactId/archive', requireRole(['ADMIN', 'MANAGER']), ClientController.archiveContact);
